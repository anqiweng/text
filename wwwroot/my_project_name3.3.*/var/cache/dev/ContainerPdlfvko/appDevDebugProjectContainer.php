...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'problembundle\\controller\\problemadmincontroller' => 'ProblemBundle\\Controller\\ProblemAdminController',
            'problembundle\\controller\\problemapicontroller' => 'ProblemBundle\\Controller\\ProblemAPIController',
            'problembundle\\controller\\problemcontroller' => 'ProblemBundle\\Controller\\ProblemController',
            'problembundle\\entitymanager\\problemmanager' => 'ProblemBundle\\EntityManager\\ProblemManager',
            ...
            'userbundle\\entitymanager\\usermanager' => 'UserBundle\\EntityManager\\UserManager',
        );
        ...
        $this->fileMap = array(
            'ProblemBundle\\Controller\\ProblemAPIController' => 'getProblemAPIControllerService.php',
            'ProblemBundle\\Controller\\ProblemAdminController' => 'getProblemAdminControllerService.php',
            'ProblemBundle\\Controller\\ProblemController' => 'getProblemControllerService.php',
            'ProblemBundle\\EntityManager\\ProblemManager' => 'getProblemManagerService.php',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController' => 'getRedirectControllerService.php',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController' => 'getTemplateControllerService.php',
            'UserBundle\\Controller\\UserController' => 'getUserControllerService.php',
            'UserBundle\\EntityManager\\UserManager' => 'getUserManagerService.php',
            ...
            'service_locator.xvurche' => 'getServiceLocator_XvurcheService.php',
        ...
        $this->privates = array(
            ...
            'templating.helper.gravatar' => true,
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/ornicar/gravatar-bundle/Ornicar/GravatarBundle/GravatarApi.php';
            ...
            include_once $this->targetDirs[3].'/vendor/ornicar/gravatar-bundle/Ornicar/GravatarBundle/Templating/Helper/GravatarHelperInterface.php';
            include_once $this->targetDirs[3].'/vendor/ornicar/gravatar-bundle/Ornicar/GravatarBundle/Templating/Helper/GravatarHelper.php';
            include_once $this->targetDirs[3].'/vendor/ornicar/gravatar-bundle/Ornicar/GravatarBundle/Twig/GravatarExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('jV3k0FwZGZ', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('naODqO+Nsb', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(${($_ = isset($this->services['twig.extension.gravatar']) ? $this->services['twig.extension.gravatar'] : $this->getTwig_Extension_GravatarService()) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hsFaDI2eEq', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('l59UKmqgTh', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lw0DsdKUDo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    /**
     * Gets the private 'gravatar.api' shared service.
     *
     * @return \Ornicar\GravatarBundle\GravatarApi
     */
    ...
    /**
     * Gets the private 'templating.helper.gravatar' shared service.
     *
     * @return \Ornicar\GravatarBundle\Templating\Helper\GravatarHelper
     */
    protected function getTemplating_Helper_GravatarService()
    {
        return $this->services['templating.helper.gravatar'] = new \Ornicar\GravatarBundle\Templating\Helper\GravatarHelper(${($_ = isset($this->services['gravatar.api']) ? $this->services['gravatar.api'] : $this->getGravatar_ApiService()) && false ?: '_'}, $this);
    }

    /**
     * Gets the private 'twig.extension.gravatar' shared service.
     *
     * @return \Ornicar\GravatarBundle\Twig\GravatarExtension
     */
    protected function getTwig_Extension_GravatarService()
    {
        return $this->services['twig.extension.gravatar'] = new \Ornicar\GravatarBundle\Twig\GravatarExtension(${($_ = isset($this->services['templating.helper.gravatar']) ? $this->services['templating.helper.gravatar'] : $this->getTemplating_Helper_GravatarService()) && false ?: '_'});
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), '!FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/HomePageBundle/Resources/views'), 'HomePage');
        $instance->addPath(($this->targetDirs[3].'/src/HomePageBundle/Resources/views'), '!HomePage');
        $instance->addPath(($this->targetDirs[3].'/src/UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'/src/ProblemBundle/Resources/views'), 'Problem');
        $instance->addPath(($this->targetDirs[3].'/src/ProblemBundle/Resources/views'), '!Problem');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'OrnicarGravatarBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/ornicar/gravatar-bundle/Ornicar/GravatarBundle'),
                    'namespace' => 'Ornicar\\GravatarBundle',
                ),
                'HomePageBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/HomePageBundle'),
                    'namespace' => 'HomePageBundle',
                ),
                'UserBundle' => array(
                ...
                'ProblemBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ProblemBundle'),
                    'namespace' => 'ProblemBundle',
                ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HomePageBundle' => 'HomePageBundle\\HomePageBundle',
                'UserBundle' => 'UserBundle\\UserBundle',
                'ProblemBundle' => 'ProblemBundle\\ProblemBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'liudan',
            'database_user' => 'root',
            'database_password' => 'liudan',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mail_from_address' => 'admin@lite.liudan.org',
            'mail_from_user' => 'liudanlite',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'form/semantic-ui-form-theme.html.twig',
            ),
